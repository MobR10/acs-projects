...
void runGameLevel() {
    ...
    std::string spells[] = { "Spell1", "Spell2", "Spell1" };
    heroInventory.addItem(new MagicBook("Carte de vraji",spells,3));
...
int main() {
    ...
    assert(Sword("nume",10).getMultiplier(10,0) == 0); // division by 0 
